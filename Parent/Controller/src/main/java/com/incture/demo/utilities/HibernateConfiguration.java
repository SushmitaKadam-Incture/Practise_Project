package com.incture.demo.utilities;
...
public class HibernateConfiguration {
	...
	public DataSource dataSource() {
		...
		// dataSource.setUrl(destProp.get(ApplicationConstants.DESC_DESCRIPTION));
		// dataSource.setUsername(destProp.get(ApplicationConstants.DESC_USER));
		// dataSource.setPassword(destProp.get(ApplicationConstants.DESC_PWD));
